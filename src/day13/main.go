...
func Dump(dots map[int]map[int]bool, step int, maxX int, maxY int, outputRoot string) {
	...
	path := fmt.Sprintf("%s/day13/output_fold_%d.png", outputRoot, step)
...
func main() {
	...
	for i, fold := range folds {
		...
		Dump(dots, i, maxX, maxY, outputRoot)
	}
